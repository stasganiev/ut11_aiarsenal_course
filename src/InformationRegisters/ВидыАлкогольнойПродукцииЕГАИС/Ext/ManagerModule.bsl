...
Процедура ОбновитьУжеСуществующиеВидыАлкогольнойПродукции()
	...
	Запрос.Текст = 
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ВидыАлкогольнойПродукцииЕГАИС КАК ВидыАлкогольнойПродукцииЕГАИС
		|		ПО ВидыАлкогольнойПродукции.Код = ВидыАлкогольнойПродукцииЕГАИС.Код
		|			И ВидыАлкогольнойПродукции.Наименование = ВидыАлкогольнойПродукцииЕГАИС.Наименование
		|ГДЕ
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		ВидАлкогольнойПродукцииОбъект.Маркируемый           = ВыборкаДетальныеЗаписи.Маркируемый;
