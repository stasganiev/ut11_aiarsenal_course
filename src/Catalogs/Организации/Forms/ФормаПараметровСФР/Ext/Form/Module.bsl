...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, Параметры, "ВидОрганизации, Организация, РегистрационныйНомерСФР, ИПРегистрационныйНомерСФР");
	
	Если ВидОрганизации = "ИндивидуальныйПредприниматель" Тогда
		Элементы.ГруппаРеквизиты.ОтображатьЗаголовок = Истина;
		Элементы.ГруппаРеквизитыИП.Видимость = Истина;
	Иначе
		Элементы.ГруппаРеквизитыИП.Видимость = Ложь;
	КонецЕсли;
	...
	ПроверитьРегистрационныйНомер(ИПРегистрационныйНомерСФР, Элементы.РезультатПроверкиИП.Заголовок, Элементы.РезультатПроверкиИП.Видимость);
...
&НаКлиенте
Процедура ИПРегистрационныйНомерСФРПриИзменении(Элемент)
	ПроверитьРегистрационныйНомер(ИПРегистрационныйНомерСФР, Элементы.РезультатПроверкиИП.Заголовок, Элементы.РезультатПроверкиИП.Видимость);
КонецПроцедуры
...
Процедура СохранитьИзмененияЗавершение(Отказ, ДополнительныеПараметры) Экспорт
	...
	СтруктураСведений.Вставить("ИПРегистрационныйНомерСФР", ИПРегистрационныйНомерСФР);
