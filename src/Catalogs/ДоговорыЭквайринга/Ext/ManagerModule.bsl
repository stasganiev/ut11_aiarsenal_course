...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Версия = "11.5.19.70";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("2fad6d50-3c1d-4348-e2d4-95d8649388de");
	...
	ШаблонКомментарияОбработчика = НСтр("ru = 'Заполнение в справочнике ""%1"" нового реквизита шапки ""%2"" при переходе на 19ый релиз. Если ""%3"" в значении ""%4"", реквизит принимает значение ""%5""'");
