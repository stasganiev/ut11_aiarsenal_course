...
&НаСервере
Процедура ВключитьОбменКадровойИсториейПриИзмененииНаСервере()
КонецПроцедуры

&НаКлиенте
Процедура ВключитьОбменКадровойИсториейПриИзменении(Элемент)
	ВключитьОбменКадровойИсториейПриИзмененииНаСервере();
КонецПроцедуры
