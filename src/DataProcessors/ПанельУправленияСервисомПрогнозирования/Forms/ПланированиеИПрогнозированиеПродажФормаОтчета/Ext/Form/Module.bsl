...
Процедура УстановитьПараметрыОтчета()
	...
	Если ЗначениеЗаполнено(ВидПлана) Тогда
		...
		УстановитьПараметрДанныхКомпоновки("ДатаНачалаВыводаФактаПродаж",    ДатаНачалаВыводаФактаПродаж);
		УстановитьПараметрДанныхКомпоновки("ПериодичностьОтчета",            ПериодичностьВидаПлана);
	КонецЕсли;
