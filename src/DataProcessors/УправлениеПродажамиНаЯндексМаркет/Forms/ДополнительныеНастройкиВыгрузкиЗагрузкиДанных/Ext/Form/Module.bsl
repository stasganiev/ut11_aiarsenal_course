...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ВариантНастроек = "ДанныеОРеализованныхТоварах" Тогда
		...
		СпособОтраженияПродаж = Параметры.ЗначенияПараметровСсылкиНаОбъект.ДополнительныеНастройки.Получить("СпособОтраженияПродаж");
		СкладОтгрузки         = Параметры.ЗначенияПараметровСсылкиНаОбъект.ДополнительныеНастройки.Получить("СкладОтгрузки");
		...
		ДоговорВзаимозачеты   = Параметры.ЗначенияПараметровСсылкиНаОбъект.ДополнительныеНастройки.Получить("ДоговорВзаимозачеты");
		...
		РозничныйПартнер      = Параметры.ЗначенияПараметровСсылкиНаОбъект.ДополнительныеНастройки.Получить("РозничныйПартнер");
		РозничныйКонтрагент   = Параметры.ЗначенияПараметровСсылкиНаОбъект.ДополнительныеНастройки.Получить("РозничныйКонтрагент");
		СоглашениеРеализация  = Параметры.ЗначенияПараметровСсылкиНаОбъект.ДополнительныеНастройки.Получить("СоглашениеРеализация");
		ДоговорРеализация     = Параметры.ЗначенияПараметровСсылкиНаОбъект.ДополнительныеНастройки.Получить("ДоговорРеализация");
