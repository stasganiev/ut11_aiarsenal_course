...
Процедура ОткрытьДокументыПоставок(Команда)
	...
	ОткрытьФормуСДополнениемПараметров(ИмяОткрываемойФормы, "РаботаСПоставкамиЯндексМаркет");
...
Процедура ОткрытьДокументыПоставокЗаявкиНаПоставку(Команда)
	...
	ОткрытьФормуСДополнениемПараметров(ИмяОткрываемойФормы, "РаботаСПоставкамиЯндексМаркет",
		"РаботаСПоставкамиЯндексМаркет" + ДанныеТорговойПлощадки.ИдентификаторКлиента);
...
Процедура ОткрытьДокументыПродаж(Команда)
	...
	ИмяОткрываемойФормы = "Обработка.ЖурналДокументовПродажи.Форма.СписокДокументов";
	ОткрытьФормуСДополнениемПараметров(ИмяОткрываемойФормы, "РаботаСПродажамиЯндексМаркет");
...
Процедура ОткрытьДокументыПродажСоСкладовТорговойПлощадкиЗаказы(Команда)
	...
	ИмяОткрываемойФормы = "Документ.ЗаказКлиента.Форма.ФормаСпискаДокументов";
	ОткрытьФормуСДополнениемПараметров(ИмяОткрываемойФормы, "РаботаСПродажамиЯндексМаркет",
		"РаботаСПродажамиЯндексМаркет" + ДанныеТорговойПлощадки.ИдентификаторКлиента);
...
Процедура ЗаполнитьДанныеПоТорговойПлощадке()
	...
	ДанныеТорговойПлощадки.СпособОтраженияПродаж    = РеквизитыУчетнойЗаписи.ДополнительныеНастройки.Получить("СпособОтраженияПродаж");
	ДанныеТорговойПлощадки.СкладОтгрузки            = РеквизитыУчетнойЗаписи.ДополнительныеНастройки.Получить("СкладОтгрузки");
	ДанныеТорговойПлощадки.ДоговорВзаимозачеты      = РеквизитыУчетнойЗаписи.ДополнительныеНастройки.Получить("ДоговорВзаимозачеты");
	ДанныеТорговойПлощадки.РозничныйПартнер         = РеквизитыУчетнойЗаписи.ДополнительныеНастройки.Получить("РозничныйПартнер");
	ДанныеТорговойПлощадки.РозничныйКонтрагент      = РеквизитыУчетнойЗаписи.ДополнительныеНастройки.Получить("РозничныйКонтрагент");
	ДанныеТорговойПлощадки.СоглашениеРеализация     = РеквизитыУчетнойЗаписи.ДополнительныеНастройки.Получить("СоглашениеРеализация");
	ДанныеТорговойПлощадки.ДоговорРеализация        = РеквизитыУчетнойЗаписи.ДополнительныеНастройки.Получить("ДоговорРеализация");
...
Функция НовыйДанныеТорговойПлощадки()
	...
	ДанныеТорговойПлощадки.Вставить("ДополнительныеНастройки",                   Новый Соответствие);
