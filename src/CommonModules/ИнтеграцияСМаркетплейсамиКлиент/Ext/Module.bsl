...
Процедура ДополнитьПараметрыФормы(ПараметрыФормы, ИсточникПараметров, ИмяОткрываемойФормы) Экспорт
	...
	Если КлючНазначенияФормы = "РаботаСПоставкамиЯндексМаркет"
			Или КлючНазначенияФормы = "РаботаСПродажамиЯндексМаркет" Тогда
	...
	Если ИмяОткрываемойФормы = "Обработка.ЖурналДокументовПродажи.Форма.СписокДокументов" Тогда
		...
		ИначеЕсли КлючНазначенияФормы = "РаботаСПоставкамиЯндексМаркет" Тогда
			КлючНазначенияОткрываемойФормы = "РаботаСПоставкамиЯндексМаркет";
			ЗаголовокФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Документы поставки <%1> (все)'"), 
				ДанныеТорговойПлощадки.ПостфиксЗаголовкаФормы);
			...
			Если КлючНазначенияИзПараметровФормы = "ВозвратТоваровОтКлиента" Тогда
				ПараметрыФормы.Вставить("КлючНазначенияФормы", "ПоступлениеТоваровОтХранителя");
			КонецЕсли;
		ИначеЕсли КлючНазначенияФормы = "РаботаСПродажамиЯндексМаркет" Тогда
			КлючНазначенияОткрываемойФормы = "РаботаСПродажамиЯндексМаркет";
			ЗаголовокФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Документы продажи <%1> (все)'"), 
				ДанныеТорговойПлощадки.ПостфиксЗаголовкаФормы);
		...
		Если КлючНазначенияОткрываемойФормы = "РаботаСПоставкамиOzon"
				Или КлючНазначенияОткрываемойФормы = "ДокументыПродажиЧерезOzon" Тогда
		...
		ИначеЕсли КлючНазначенияОткрываемойФормы = "РаботаСПоставкамиЯндексМаркет"
					Или КлючНазначенияОткрываемойФормы = "РаботаСПродажамиЯндексМаркет"
					Или КлючНазначенияОткрываемойФормы = "ДокументыПродажиЧерезЯндексМаркет" Тогда
			Если ДанныеТорговойПлощадки.СхемаРаботы = ПредопределенноеЗначение("Перечисление.СхемыРаботыТорговыхПлощадок.FBO") Тогда
				Если ДанныеТорговойПлощадки.СпособОтраженияПродаж = СпособОтраженияПродаж_Реализация Тогда
					Если ЗначениеЗаполнено(ДанныеТорговойПлощадки.СкладОтгрузки) Тогда
						БыстрыйОтбор.Вставить("Склад", ДанныеТорговойПлощадки.СкладОтгрузки);
					КонецЕсли;
				Иначе
					Если ЗначениеЗаполнено(ДанныеТорговойПлощадки.Партнер) Тогда
						Отбор.Вставить("Партнер", ДанныеТорговойПлощадки.Партнер);
		...
		ИначеЕсли КлючНазначенияОткрываемойФормы = "ДокументыПродажиЧерезOzon" Тогда
			ФиксированныеНастройки = ПолучитьФиксированныеНастройкиОткрытияСпискаДокументов(ФиксированныеНастройки, 
				ДанныеТорговойПлощадки, "ВсеДоговоры");
			
		ИначеЕсли КлючНазначенияОткрываемойФормы = "РаботаСПоставкамиЯндексМаркет"
					Или КлючНазначенияОткрываемойФормы = "РаботаСПродажамиЯндексМаркет" Тогда
			Если ДанныеТорговойПлощадки.СхемаРаботы = ПредопределенноеЗначение("Перечисление.СхемыРаботыТорговыхПлощадок.FBO") Тогда
				Если ДанныеТорговойПлощадки.СпособОтраженияПродаж = СпособОтраженияПродаж_Реализация
						И ЗначениеЗаполнено(ДанныеТорговойПлощадки.ДоговорРеализация) Тогда
					Отбор.Вставить("Договор", ДанныеТорговойПлощадки.ДоговорРеализация);
				ИначеЕсли ДанныеТорговойПлощадки.СпособОтраженияПродаж = СпособОтраженияПродаж_Комиссия
						И ЗначениеЗаполнено(ДанныеТорговойПлощадки.ДоговорКомиссия) Тогда
					Отбор.Вставить("Договор", ДанныеТорговойПлощадки.ДоговорКомиссия);
				КонецЕсли;
			КонецЕсли;
		ИначеЕсли КлючНазначенияОткрываемойФормы = "ДокументыПродажиЧерезЯндексМаркет" Тогда
		...
		ИначеЕсли КлючНазначенияОткрываемойФормы = "РаботаСПоставкамиЯндексМаркет" Тогда
			ИспользуемыеХозОперации = ИнтеграцияСЯндексМаркетВызовСервера.ИспользуемыеХозяйственныеОперации(
				ДанныеТорговойПлощадки.ПостфиксЗаголовкаФормы);
			Если ДанныеТорговойПлощадки.СхемаРаботы = ПредопределенноеЗначение("Перечисление.СхемыРаботыТорговыхПлощадок.FBO")
					И ДанныеТорговойПлощадки.СпособОтраженияПродаж = СпособОтраженияПродаж_Комиссия Тогда
				ПараметрыФормы.Вставить("ИспользуемыеХозОперации", ИспользуемыеХозОперации.ПоставкиКомиссия);
			Иначе
				ПараметрыФормы.Вставить("ИспользоватьЗагрузкуСохраненныхНастроек", Истина);
			КонецЕсли;
		ИначеЕсли КлючНазначенияОткрываемойФормы = "РаботаСПродажамиЯндексМаркет" Тогда
			ИспользуемыеХозОперации = ИнтеграцияСЯндексМаркетВызовСервера.ИспользуемыеХозяйственныеОперации(
				ДанныеТорговойПлощадки.ПостфиксЗаголовкаФормы);
			Если ДанныеТорговойПлощадки.СхемаРаботы = ПредопределенноеЗначение("Перечисление.СхемыРаботыТорговыхПлощадок.FBO") Тогда
				Если ДанныеТорговойПлощадки.СпособОтраженияПродаж = СпособОтраженияПродаж_Реализация Тогда
					ПараметрыФормы.Вставить("ИспользуемыеХозОперации", ИспользуемыеХозОперации.ПродажиРеализация);
				ИначеЕсли ДанныеТорговойПлощадки.СпособОтраженияПродаж = СпособОтраженияПродаж_Комиссия Тогда
					ПараметрыФормы.Вставить("ИспользуемыеХозОперации", ИспользуемыеХозОперации.ПродажиКомиссия);
				КонецЕсли;
			Иначе
				ПараметрыФормы.Вставить("ИспользоватьЗагрузкуСохраненныхНастроек", Истина);
				КлючНазначенияОткрываемойФормы = "ДокументыПродажи";
			КонецЕсли;
		КонецЕсли;

		ПараметрыФормы.Вставить("ИспользоватьЗагрузкуНастроек", Истина);
		ПараметрыФормы.Вставить("УникальныйИдентификаторФормы",
			Строка(ДанныеТорговойПлощадки.УникальныйИдентификатор) 
				+ КлючНазначенияОткрываемойФормы
				+ ?(ПустаяСтрока(КлючНазначенияИзПараметровФормы) 
						Или КлючНазначенияОткрываемойФормы = КлючНазначенияФормы, "", КлючНазначенияИзПараметровФормы));
	...
	ИначеЕсли ИмяОткрываемойФормы = "Обработка.ЖурналДокументовОтчетыКомиссионеров.Форма.КОформлениюОтчетовКомиссионеров" Тогда
		...
		Если КлючНазначенияФормы = "РаботаСПродажамиOzon"
			...
			ЗаголовокФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				...
				ДанныеТорговойПлощадки.ПостфиксЗаголовкаФормы);
		ИначеЕсли КлючНазначенияФормы = "РаботаСПродажамиЯндексМаркет"
				Или КлючНазначенияФормы = "ДокументыПоставкиЧерезЯндексМаркет" Тогда
			КлючНазначенияОткрываемойФормы = "РаботаСПродажамиЯндексМаркет";
			ЗаголовокФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Отчеты комиссионеров о продажах/Реализации через комиссионеров (к оформлению) <%1>'"), 
				ДанныеТорговойПлощадки.ПостфиксЗаголовкаФормы);
	...
	ИначеЕсли ИмяОткрываемойФормы = "Документ.АктОРасхожденияхПослеОтгрузки.Форма.ФормаСписка" Тогда
		...
		Если КлючНазначенияОткрываемойФормы = "РаботаСПоставкамиOzon" Тогда
			Если ЗначениеЗаполнено(ДанныеТорговойПлощадки.ДоговорПродажиЧерезСкладыТорговойПлощадки) Тогда
				Отбор.Вставить("Договор", ДанныеТорговойПлощадки.ДоговорПродажиЧерезСкладыТорговойПлощадки);
			КонецЕсли;
			
		ИначеЕсли КлючНазначенияОткрываемойФормы = "РаботаСПоставкамиЯндексМаркет" Тогда
			Если ДанныеТорговойПлощадки.СхемаРаботы = ПредопределенноеЗначение("Перечисление.СхемыРаботыТорговыхПлощадок.FBO")
					И ДанныеТорговойПлощадки.СпособОтраженияПродаж = СпособОтраженияПродаж_Комиссия
					И ЗначениеЗаполнено(ДанныеТорговойПлощадки.ДоговорКомиссия) Тогда
				Отбор.Вставить("Договор", ДанныеТорговойПлощадки.ДоговорКомиссия);
			КонецЕсли;
		КонецЕсли;
	...
	ИначеЕсли ИмяОткрываемойФормы = "Обработка.ЖурналДокументовНДС.Форма.СписокДокументов" Тогда
		...
		Если Не БыстрыйОтбор.Свойство("Контрагент")
			И ЗначениеЗаполнено(ДанныеТорговойПлощадки.Контрагент) Тогда
	...
	ИначеЕсли ИмяОткрываемойФормы = "Документ.ПриобретениеУслугПрочихАктивов.ФормаСписка" Тогда
		...
		ИначеЕсли КлючНазначенияФормы = "ВзаиморасчетыЯндексМаркет" Тогда
			КлючНазначенияОткрываемойФормы = "ВзаиморасчетыЯндексМаркет";
			ЗаголовокФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Приобретение услуг и прочих активов <%1>'"), ДанныеТорговойПлощадки.ПостфиксЗаголовкаФормы + ", %1");
		Иначе
			Возврат;
	...
	ИначеЕсли ИмяОткрываемойФормы = "Обработка.ЖурналДокументовВнутреннегоТовародвижения.Форма.СписокДокументов" Тогда
		...
		Если КлючНазначенияФормы = "РаботаСПоставкамиЯндексМаркет" Тогда
			КлючНазначенияОткрываемойФормы = "РаботаСПоставкамиЯндексМаркет";
			ЗаголовокФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Документы поставки <%1> (все)'"), 
				ДанныеТорговойПлощадки.ПостфиксЗаголовкаФормы);
		...
		Если КлючНазначенияОткрываемойФормы = "РаботаСПоставкамиЯндексМаркет" Тогда
			Если ДанныеТорговойПлощадки.СхемаРаботы = ПредопределенноеЗначение("Перечисление.СхемыРаботыТорговыхПлощадок.FBO")
					И ДанныеТорговойПлощадки.СпособОтраженияПродаж = СпособОтраженияПродаж_Реализация
					И ЗначениеЗаполнено(ДанныеТорговойПлощадки.СкладОтгрузки) Тогда
				БыстрыйОтбор.Вставить("Склад", ДанныеТорговойПлощадки.СкладОтгрузки);
			КонецЕсли;
		КонецЕсли;
		...
		Если КлючНазначенияОткрываемойФормы = "РаботаСПоставкамиЯндексМаркет" Тогда
			ИспользуемыеХозОперации = ИнтеграцияСЯндексМаркетВызовСервера.ИспользуемыеХозяйственныеОперации(
				ДанныеТорговойПлощадки.ПостфиксЗаголовкаФормы);
			Если ДанныеТорговойПлощадки.СхемаРаботы = ПредопределенноеЗначение("Перечисление.СхемыРаботыТорговыхПлощадок.FBO")
					И ДанныеТорговойПлощадки.СпособОтраженияПродаж = СпособОтраженияПродаж_Реализация Тогда
				ПараметрыФормы.Вставить("ИспользуемыеХозОперации", ИспользуемыеХозОперации.ПоставкиРеализация);
			Иначе
				ПараметрыФормы.Вставить("ИспользоватьЗагрузкуСохраненныхНастроек", Истина);
			КонецЕсли;
		КонецЕсли;
	...
	ИначеЕсли ИмяОткрываемойФормы = "Обработка.ЖурналДокументовВнутреннегоТовародвижения.Форма.СписокДокументовКОформлению" Тогда
		...
		Если КлючНазначенияФормы = "РаботаСПоставкамиЯндексМаркет" Тогда
			КлючНазначенияОткрываемойФормы = "ВнутреннееТовародвижение";
			ЗаголовокФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Документы поставки (к оформлению) <%1>'"), ДанныеТорговойПлощадки.ПостфиксЗаголовкаФормы);
	...
	ИначеЕсли ИмяОткрываемойФормы = "Документ.ЗаказНаПеремещение.Форма.ФормаСписка" Тогда
		...
		Если КлючНазначенияОткрываемойФормы = "РаботаСПоставкамиЯндексМаркет" Тогда
			Если ДанныеТорговойПлощадки.СхемаРаботы = ПредопределенноеЗначение("Перечисление.СхемыРаботыТорговыхПлощадок.FBO")
					И ДанныеТорговойПлощадки.СпособОтраженияПродаж = СпособОтраженияПродаж_Реализация
					И ЗначениеЗаполнено(ДанныеТорговойПлощадки.СкладОтгрузки) Тогда
				Отбор.Вставить("СкладПолучатель", ДанныеТорговойПлощадки.СкладОтгрузки);
			КонецЕсли;
		КонецЕсли;
	...
	ИначеЕсли ИмяОткрываемойФормы = "Документ.ВзаимозачетЗадолженности.ФормаСписка" Тогда
		...
		Если КлючНазначенияФормы = "ВзаиморасчетыOzon" Тогда
			КлючНазначенияОткрываемойФормы = "ВзаиморасчетыOzon";
			ЗаголовокФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Взаимозачеты задолженности <%1>'"), ДанныеТорговойПлощадки.ПостфиксЗаголовкаФормы);
		ИначеЕсли КлючНазначенияФормы = "ВзаиморасчетыЯндексМаркет" Тогда
			КлючНазначенияОткрываемойФормы = "ВзаиморасчетыЯндексМаркет";
			ЗаголовокФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Взаимозачеты задолженности <%1>'"), ДанныеТорговойПлощадки.ПостфиксЗаголовкаФормы);
	...
	ИначеЕсли ИмяОткрываемойФормы = "Обработка.ЖурналДокументовБезналичныеПлатежи.Форма.ФормаСписка" Тогда
		...
		Если КлючНазначенияФормы = "ВзаиморасчетыOzon" Тогда
			КлючНазначенияОткрываемойФормы = "ВзаиморасчетыOzon";  
			ЗаголовокФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Безналичные платежи <%1>'"), ДанныеТорговойПлощадки.ПостфиксЗаголовкаФормы);
		ИначеЕсли КлючНазначенияФормы = "ВзаиморасчетыЯндексМаркет" Тогда
			КлючНазначенияОткрываемойФормы = "ВзаиморасчетыЯндексМаркет";
			ЗаголовокФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Безналичные платежи <%1>'"), ДанныеТорговойПлощадки.ПостфиксЗаголовкаФормы);
