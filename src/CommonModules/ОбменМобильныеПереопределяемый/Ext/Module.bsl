...
//
// Параметры:
// 	Данные - ЛюбаяСсылка, РегистрСведенийНаборЗаписей - объект, набор записей,... который нужно проверить.
//		То, что переносится везде, не обрабатывается.
//  УзелОбмена - ПланОбменаСсылка - узел плана обмена, куда осуществляется перенос
//
// Возвращаемое значение:
// 	Булево - если Истина - необходимо выполнять перенос,
...
// и записывает его определенным образом в формат XML.
//
// Параметры:
...
// и читает из него данные определенным образом.
//
// Параметры:
