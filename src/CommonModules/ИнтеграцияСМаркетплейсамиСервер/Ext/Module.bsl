...
//   - Структура Из КлючИЗначение - если запрашивается результат в виде структуры:
...
Процедура УстановитьПроцентПрогресса(Знач ВсегоОбрабатываемыхОбъектов, ИндексТекущегоОбъекта,
	...
	Процент = (ИндексТекущегоОбъекта / ВсегоОбрабатываемыхОбъектов) * ПараметрыПрогресса.ШагИтерацииВПроцентах
