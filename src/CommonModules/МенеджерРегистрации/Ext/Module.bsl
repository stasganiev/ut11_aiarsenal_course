// Регистрация ERP_EnterpriseData_RegistrationRules_2.5.19 от 17.07.2024 15:01:33
...
Функция ПараметрыРегистрации() Экспорт
	...
	Наименование = НСтр("ru = 'Правила регистрации для конфигурации ERP 2.5.19'");
	Результат.Вставить("Наименование", Наименование);
	Результат.Вставить("ДатаВремяСоздания", Дата(2024,7,17,15,1,0));
	...
	Результат.Вставить("ВерсияКонфигурации", "2.5.17");
